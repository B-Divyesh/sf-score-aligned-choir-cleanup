# Score-Aligned Choir Cleanup (`score-aligned-choir-cleanup`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://score-aligned-choir-cleanup.sociobot.in`. Artifact class: `desktop-app`.
