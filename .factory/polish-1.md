...
All earlier defects—source replacement/right reset, purchase return, hidden PDF control, dark contrast, touch targets, service-worker cleanup, offline, and installer checksums—remain covered by the full suite. No finding is deferred.
