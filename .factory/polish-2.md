...
Repair release commit: `ffcceda`. Static deployment: production `score-aligned-choir-cleanup.sociobot.in` on 2026-08-28. Live evidence: `test-results/polish-2/live-first-screen-390.png` and `test-results/polish-2/live-demo-390.png`, generated by `npm run verify:live` against the cold production URL.
